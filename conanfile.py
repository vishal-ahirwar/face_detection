...
class face_detectionConan(ConanFile):
    name = "face_detection" # The package name should be the library's name
    version = "0.1.0"
    ...
    def package_info(self):
        ...
        self.cpp_info.libs = ["face_detectionlib"] #Only if you have single lib if you component then
